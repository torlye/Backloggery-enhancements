...
define("utils", ["require", "exports"], function (require, exports) {
    ...
    exports.isNonEmpty = exports.isNonNullish = void 0;
...
*/
define("script", ["require", "exports", "utils"], function (require, exports, utils_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    /*
    ...
    */
    ...
    function createIconsFromKeyWord(word, iconsNode) {
        ...
        if (keyWord) {
            ...
            if ((0, utils_1.isNonNullish)(iconNumber)) {
    ...
    function updateStatusChart(headerSection) {
        ...
        if (!(0, utils_1.isNonEmpty)(unfinishedCount) ||
            !(0, utils_1.isNonEmpty)(beatenCount) ||
            !(0, utils_1.isNonEmpty)(completedCount) ||
